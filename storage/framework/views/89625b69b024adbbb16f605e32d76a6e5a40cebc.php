...
<head>
    ...
    <?php if(\Laravel\Telescope\Telescope::$useDarkTheme): ?>
        <link href='<?php echo e(asset(mix('app-dark.css', 'vendor/telescope'))); ?>' rel='stylesheet' type='text/css'>
    <?php else: ?>
        <link href='<?php echo e(asset(mix('app.css', 'vendor/telescope'))); ?>' rel='stylesheet' type='text/css'>
    <?php endif; ?>
</head>
<body>
